...
![The Fetch window on the search screen in the Blizzard theme: a query with its results listed by size, each one labelled with its kind and its source.](assets/fetch-search-blizzard.png)
...
[Privacy](PRIVACY.md) ·
[The site](https://fetch.madebynikesh.com/)
